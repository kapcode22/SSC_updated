...
const club = () => {
    const team = [
      { name: "Ayush Sarangi", img: ayush, post: "Jt. General Secy" },
      { name: "Mithilesh", img: mith, post: "General Secy" },
      { name: "Kapil Rahngdale", img: kapil, post: "General Secy" },
    ];
    return (
      <div className={styles.bodies}>
        ...
        <div className={styles.club_header}>
          <h2>Social Projects Club</h2>
          <p>“Innovate, Empower, Impact: Shaping Futures Together”</p>
        </div>
        ...
        <div className={`${styles.about} ${styles.container}`}>
          ...
          <div className={styles.aboutContent}>
            ...
            <p className={styles.dis}>
              ...
              relieve the challenges faced by underprivileged individuals in
              areas like Patiya, Kakarmatta, and Lahartara. Centered on improved
              hygiene and importance of education, the initiative aims to
              enhance the standard of living and awareness among the less
              fortunate. Through individual engagement, free medical camps, and
              awareness campaigns,we strive to address their unique needs and
              nurture positive transformation within these communities.
            </p>
          ...
          <div className={styles.event}>
            <div className={styles.eventContent}>
              ...
              <p>
                ...
                January 2023 inKakarmatta Basti by Kashi Utkarsh, affiliated
                with IIT BHU.
              </p>
              <p>
                The event’s objective was to cultivate sports interest in
                children with their academic goals .It aimed to nurture
                sportsmanship values, offer a platform for showcasing talent,
                introduce kids to diverse games, and promote awareness about the
                significance of physical activities in daily routines.
              </p>
            </div>
            <img src={header} alt="" />
          ...
          <div className={styles.event}>
            <div className={styles.eventContent}>
              ...
              <p className={styles.dis}>
                ...
                Asperiores iste magnam temporibus eligendi quod sequi aliquam
                autem accusantium quam. Magni labore autem quisquam molestias
                error? Odit et maiores unde porro.
              </p>
            </div>
            <img src={header} alt="" />
            <div className={styles.date}></div>
