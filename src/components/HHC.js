    ...
    return (
      <div>
        ...
        <div className={styles.club_header}>
          <h2>Health & Hygiene Club</h2>
          <p>“Promoting Wellness, Cultivating Hygiene”</p>
        </div>
        ...
        <div className={`${styles.events} ${styles.container}`}>
          ...
          <div className={styles.event}>
            <div className={styles.eventContent}>
              ...
              <p>
                “Spot the Green” was an initiative Organized by the Health and
                Hygiene Club with the goal of advocating for tree plantation
              ...
              <p>
                ...
                air purification and wildlife habitat. Hands-on tree planting
                lets participants contribute and learn techniques.{" "}
              </p>
            </div>
            <img src={header} alt="" />
          ...
          <div className={styles.event}>
            <div className={styles.eventContent}>
              ...
              <p className={styles.dis}>
                ...
                and within their expiration dates. By collecting medicines from
                the students, the Health and Hygiene Club sought to build a pool
                of resources that could be utilized to support healthcare
                initiatives.
              </p>
            </div>
            <img src={header} alt="" />
